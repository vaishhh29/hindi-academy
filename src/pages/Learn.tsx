        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <motion.button 
                className="flex items-center justify-center gap-3 bg-orange-500 text-white px-8 sm:px-10 py-4 rounded-full font-extrabold text-lg shadow-xl hover:bg-orange-600 transition-all transform hover:scale-105"
                animate={{ scale: [1, 1.03, 1] }}
                transition={{ duration: 2, repeat: Infinity }}
                whileHover={{ scale: 1.05, gap: '1rem', transition: { duration: 0.2 } }}
                whileTap={{ scale: 0.95 }}
              >
